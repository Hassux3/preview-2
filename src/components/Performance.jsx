    ...
    <div className="py-32 bg-[#030712] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            <div className="inline-block text-[#8B5CF6] font-orbitron font-bold text-xs tracking-widest mb-4 border border-[#8B5CF6]/20 px-3 py-1 rounded-full bg-[#8B5CF6]/5">BENCHMARK DATA v4.0</div>
            <h2 className="text-4xl md:text-6xl font-orbitron font-black mb-8 leading-tight">
              SCALABILITY <br /> <span className="bg-gradient-to-r from-[#00D4FF] to-[#8B5CF6] bg-clip-text text-transparent">BY DESIGN</span>
            </h2>
            <p className="text-xl text-gray-400 mb-10 leading-relaxed font-light">
              Our DPDK-based user plane delivers linear scalability. As you add CPU cores, performance grows predictably. No performance degradation, no overhead.
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-6 glass-card rounded-[1.5rem] border border-white/5 hover:border-white/10 transition-all">
                  <span className="text-gray-300 font-medium">{item.label}</span>
                  <span className="text-[#00D4FF] font-orbitron font-bold text-xl">{item.val}</span>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="h-[500px] glass-card p-10 rounded-[3rem] relative z-10 border border-white/10 shadow-2xl backdrop-blur-xl">
               <div className="flex justify-between items-center mb-10">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-gray-400 uppercase tracking-[0.2em] font-bold">Throughput (Gbps)</span>
                  </div>
                  <div className="text-[10px] text-gray-600 font-mono">INTEL® XEON® PLATINUM 8380</div>
               </div>
